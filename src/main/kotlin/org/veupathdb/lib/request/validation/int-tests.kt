 ...
 * @since 0.2.0
 */
inline fun Int.checkMinimum(jPath: String, min: Int, errors: ValidationErrors): Boolean {
  if (this < min) {
 ...
 * @since 0.2.0
 */
inline fun Int.checkMinimum(jPath: String, index: Int, min: Int, errors: ValidationErrors): Boolean {
  if (this < min) {
 ...
 * @since 0.2.0
 */
inline fun Int.checkMaximum(jPath: String, max: Int, errors: ValidationErrors): Boolean {
  if (this > max) {
 ...
 * @since 0.2.0
 */
inline fun Int.checkMaximum(jPath: String, index: Int, max: Int, errors: ValidationErrors): Boolean {
  if (this > max) {
 ...
 * @since 0.2.0
 */
inline fun Int.checkInRange(jPath: String, min: Int, max: Int, errors: ValidationErrors) =
 ...
 * @since 0.2.0
 */
inline fun Int.checkInRange(jPath: String, range: IntRange, errors: ValidationErrors) =
 ...
 * @since 0.2.0
 */
inline fun Int.checkInRange(jPath: String, index: Int, min: Int, max: Int, errors: ValidationErrors) =
 ...
 * @since 0.2.0
 */
inline fun Int.checkInRange(jPath: String, index: Int, range: IntRange, errors: ValidationErrors) =
 ...
 * @since 0.2.0
 */
inline fun Int?.optCheckMinimum(jPath: String, min: Int, errors: ValidationErrors) =
 ...
 * @since 0.2.0
 */
inline fun Int?.optCheckMinimum(jPath: String, index: Int, min: Int, errors: ValidationErrors) =
 ...
 * @since 0.2.0
 */
inline fun Int?.optCheckMaximum(jPath: String, max: Int, errors: ValidationErrors) =
 ...
 * @since 0.2.0
 */
inline fun Int?.optCheckMaximum(jPath: String, index: Int, max: Int, errors: ValidationErrors) =
 ...
 * @since 0.2.0
 */
inline fun Int?.optCheckInRange(jPath: String, min: Int, max: Int, errors: ValidationErrors) =
  this?.let {
 ...
 * @since 0.2.0
 */
inline fun Int?.optCheckInRange(jPath: String, range: IntRange, errors: ValidationErrors) =
  this?.let {
 ...
 * @since 0.2.0
 */
inline fun Int?.optCheckInRange(jPath: String, index: Int, min: Int, max: Int, errors: ValidationErrors) =
  this?.let {
 ...
 * @since 0.2.0
 */
inline fun Int?.optCheckInRange(jPath: String, index: Int, range: IntRange, errors: ValidationErrors) =
  this?.let {
...
inline fun Int?.reqCheckMinimum(jPath: String, min: Int, errors: ValidationErrors): Boolean {
 ...
 */
@OptIn(ExperimentalContracts::class)
inline fun Int?.reqCheckMinimum(jPath: String, index: Int, min: Int, errors: ValidationErrors): Boolean {
  contract { returns(true) implies(this@reqCheckMinimum != null) }
 ...
 */
@OptIn(ExperimentalContracts::class)
inline fun Int?.reqCheckMaximum(jPath: String, max: Int, errors: ValidationErrors): Boolean {
 ...
 */
@OptIn(ExperimentalContracts::class)
inline fun Int?.reqCheckMaximum(jPath: String, index: Int, max: Int, errors: ValidationErrors): Boolean {
  contract { returns(true) implies(this@reqCheckMaximum != null) }
 ...
 */
@OptIn(ExperimentalContracts::class)
inline fun Int?.reqCheckInRange(jPath: String, min: Int, max: Int, errors: ValidationErrors): Boolean {
 ...
 */
@OptIn(ExperimentalContracts::class)
inline fun Int?.reqCheckInRange(jPath: String, range: IntRange, errors: ValidationErrors): Boolean {
  contract { returns(true) implies(this@reqCheckInRange != null) }
 ...
 */
@OptIn(ExperimentalContracts::class)
inline fun Int?.reqCheckInRange(jPath: String, index: Int, min: Int, max: Int, errors: ValidationErrors): Boolean {
  contract { returns(true) implies(this@reqCheckInRange != null) }
 ...
 */
@OptIn(ExperimentalContracts::class)
inline fun Int?.reqCheckInRange(jPath: String, index: Int, range: IntRange, errors: ValidationErrors): Boolean {
  contract { returns(true) implies(this@reqCheckInRange != null) }
